    ...
    <main>
      <section>
        <div className="bg-orange">
          ...
          <a className="font-lexend" href="https://www.webmotors.com.br/sedans?gclsrc=aw.ds&gad_source=1&gclid=CjwKCAjw7-SvBhB6EiwAwYdCAY6QsoQYV9pwlcNHKpXhWd2FlsExZ2QeHZx31iVQoaHagiNlGW5T2xoCXUwQAvD_BwE" target="_blank">Ver mais</a>
        </div>
